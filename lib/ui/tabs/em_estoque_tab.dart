...
class EmEstoqueTab extends StatefulWidget {
  @override
  State<EmEstoqueTab> createState() => _EmEstoqueTabState();
}

class _EmEstoqueTabState extends State<EmEstoqueTab> {
  ...
  void _reload() {
    this.futureList = StockModel.of(context).fetch('em estoque');
  }
