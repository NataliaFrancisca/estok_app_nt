...
class EmFaltaTab extends StatefulWidget {
  @override
  State<EmFaltaTab> createState() => _EmFaltaTabState();
}

class _EmFaltaTabState extends State<EmFaltaTab> {
  ...
  void _reload() {
    this.futureList = StockModel.of(context).fetch('em falta');
  }
